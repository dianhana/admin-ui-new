...
function MainLayout(props) {
  ...
  return (
    <div className={`flex min-h-screen ${theme.name}`}>
      {/* Sidebar */}
      <aside className="bg-black w-28 sm:w-64 text-white flex flex-col justify-between px-7 py-12">
        <div>
          {/* Logo */}
          <div className="mb-10">
          ...
          <nav>
            {menu.map((item) => (
              <NavLink
                ...
                to={item.link}
                className={({ isActive }) =>
                  `flex px-4 py-3 rounded-md mb-2 transition-all duration-200 ${
                    isActive
      ...
      <div className="bg-special-mainBg flex-1 flex flex-col">
        <header className="border-b border-gray-300 px-6 py-7 flex justify-between items-center">
